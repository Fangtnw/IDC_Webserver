...
declare module 'rclnodejs' {
  ...
  namespace msg_interfaces {
    namespace srv {
      export interface ClearScoreConstructor extends ROSService {
        readonly Request: ClearScore_RequestConstructor;
        readonly Response: ClearScore_ResponseConstructor;
      }
      export interface ClearScore_Request {
        clear_score_command: std_msgs.msg.Empty;
      }
      export interface ClearScore_RequestConstructor {
        new(other?: ClearScore_Request): ClearScore_Request;
      }
      export interface ClearScore_Response {
      }
      export interface ClearScore_ResponseConstructor {
        new(other?: ClearScore_Response): ClearScore_Response;
      }
      export interface CloseKeyConstructor extends ROSService {
        readonly Request: CloseKey_RequestConstructor;
        readonly Response: CloseKey_ResponseConstructor;
      }
      export interface CloseKey_Request {
        close_key_command: std_msgs.msg.Empty;
      }
      export interface CloseKey_RequestConstructor {
        new(other?: CloseKey_Request): CloseKey_Request;
      }
      export interface CloseKey_Response {
      }
      export interface CloseKey_ResponseConstructor {
        new(other?: CloseKey_Response): CloseKey_Response;
      }
      export interface FreePlayConstructor extends ROSService {
        readonly Request: FreePlay_RequestConstructor;
        readonly Response: FreePlay_ResponseConstructor;
      }
      export interface FreePlay_Request {
        free_play_command: std_msgs.msg.Empty;
      }
      export interface FreePlay_RequestConstructor {
        new(other?: FreePlay_Request): FreePlay_Request;
      }
      export interface FreePlay_Response {
      }
      export interface FreePlay_ResponseConstructor {
        new(other?: FreePlay_Response): FreePlay_Response;
      }
      export interface OpenKeyConstructor extends ROSService {
        readonly Request: OpenKey_RequestConstructor;
        readonly Response: OpenKey_ResponseConstructor;
      }
      export interface OpenKey_Request {
        open_key_command: std_msgs.msg.Empty;
      }
      export interface OpenKey_RequestConstructor {
        new(other?: OpenKey_Request): OpenKey_Request;
      }
      export interface OpenKey_Response {
      }
      export interface OpenKey_ResponseConstructor {
        new(other?: OpenKey_Response): OpenKey_Response;
      }
      export interface ResetConstructor extends ROSService {
        readonly Request: Reset_RequestConstructor;
        readonly Response: Reset_ResponseConstructor;
      }
      export interface Reset_Request {
        reset_command: std_msgs.msg.Empty;
      }
      export interface Reset_RequestConstructor {
        new(other?: Reset_Request): Reset_Request;
      }
      export interface Reset_Response {
      }
      export interface Reset_ResponseConstructor {
        new(other?: Reset_Response): Reset_Response;
      }
      export interface SpawnObjConstructor extends ROSService {
        readonly Request: SpawnObj_RequestConstructor;
        readonly Response: SpawnObj_ResponseConstructor;
      }
      export interface SpawnObj_Request {
        spawn_command: std_msgs.msg.Empty;
      }
      export interface SpawnObj_RequestConstructor {
        new(other?: SpawnObj_Request): SpawnObj_Request;
      }
      export interface SpawnObj_Response {
      }
      export interface SpawnObj_ResponseConstructor {
        new(other?: SpawnObj_Response): SpawnObj_Response;
      }
      export interface StartConstructor extends ROSService {
        readonly Request: Start_RequestConstructor;
        readonly Response: Start_ResponseConstructor;
      }
      export interface StartRecordConstructor extends ROSService {
        readonly Request: StartRecord_RequestConstructor;
        readonly Response: StartRecord_ResponseConstructor;
      }
      export interface StartRecord_Request {
        start_record_command: std_msgs.msg.Empty;
      }
      export interface StartRecord_RequestConstructor {
        new(other?: StartRecord_Request): StartRecord_Request;
      }
      export interface StartRecord_Response {
      }
      export interface StartRecord_ResponseConstructor {
        new(other?: StartRecord_Response): StartRecord_Response;
      }
      export interface StartScoreConstructor extends ROSService {
        readonly Request: StartScore_RequestConstructor;
        readonly Response: StartScore_ResponseConstructor;
      }
      export interface StartScore_Request {
        start_score_command: std_msgs.msg.Empty;
      }
      export interface StartScore_RequestConstructor {
        new(other?: StartScore_Request): StartScore_Request;
      }
      export interface StartScore_Response {
      }
      export interface StartScore_ResponseConstructor {
        new(other?: StartScore_Response): StartScore_Response;
      }
      export interface Start_Request {
        start_command: std_msgs.msg.Empty;
      }
      export interface Start_RequestConstructor {
        new(other?: Start_Request): Start_Request;
      }
      export interface Start_Response {
      }
      export interface Start_ResponseConstructor {
        new(other?: Start_Response): Start_Response;
      }
      export interface StopRecordConstructor extends ROSService {
        readonly Request: StopRecord_RequestConstructor;
        readonly Response: StopRecord_ResponseConstructor;
      }
      export interface StopRecord_Request {
        stop_record_command: std_msgs.msg.Empty;
      }
      export interface StopRecord_RequestConstructor {
        new(other?: StopRecord_Request): StopRecord_Request;
      }
      export interface StopRecord_Response {
      }
      export interface StopRecord_ResponseConstructor {
        new(other?: StopRecord_Response): StopRecord_Response;
      }
      export interface TimeOutConstructor extends ROSService {
        readonly Request: TimeOut_RequestConstructor;
        readonly Response: TimeOut_ResponseConstructor;
      }
      export interface TimeOut_Request {
        timeout_command: std_msgs.msg.Empty;
      }
      export interface TimeOut_RequestConstructor {
        new(other?: TimeOut_Request): TimeOut_Request;
      }
      export interface TimeOut_Response {
      }
      export interface TimeOut_ResponseConstructor {
        new(other?: TimeOut_Response): TimeOut_Response;
      }
    }
  }
  ...
  type MessagesMap = {
    ...
    'msg_interfaces/srv/ClearScore_Request': msg_interfaces.srv.ClearScore_Request,
    'msg_interfaces/srv/ClearScore_Response': msg_interfaces.srv.ClearScore_Response,
    'msg_interfaces/srv/CloseKey_Request': msg_interfaces.srv.CloseKey_Request,
    'msg_interfaces/srv/CloseKey_Response': msg_interfaces.srv.CloseKey_Response,
    'msg_interfaces/srv/FreePlay_Request': msg_interfaces.srv.FreePlay_Request,
    'msg_interfaces/srv/FreePlay_Response': msg_interfaces.srv.FreePlay_Response,
    'msg_interfaces/srv/OpenKey_Request': msg_interfaces.srv.OpenKey_Request,
    'msg_interfaces/srv/OpenKey_Response': msg_interfaces.srv.OpenKey_Response,
    'msg_interfaces/srv/Reset_Request': msg_interfaces.srv.Reset_Request,
    'msg_interfaces/srv/Reset_Response': msg_interfaces.srv.Reset_Response,
    'msg_interfaces/srv/SpawnObj_Request': msg_interfaces.srv.SpawnObj_Request,
    'msg_interfaces/srv/SpawnObj_Response': msg_interfaces.srv.SpawnObj_Response,
    'msg_interfaces/srv/StartRecord_Request': msg_interfaces.srv.StartRecord_Request,
    'msg_interfaces/srv/StartRecord_Response': msg_interfaces.srv.StartRecord_Response,
    'msg_interfaces/srv/StartScore_Request': msg_interfaces.srv.StartScore_Request,
    'msg_interfaces/srv/StartScore_Response': msg_interfaces.srv.StartScore_Response,
    'msg_interfaces/srv/Start_Request': msg_interfaces.srv.Start_Request,
    'msg_interfaces/srv/Start_Response': msg_interfaces.srv.Start_Response,
    'msg_interfaces/srv/StopRecord_Request': msg_interfaces.srv.StopRecord_Request,
    'msg_interfaces/srv/StopRecord_Response': msg_interfaces.srv.StopRecord_Response,
    'msg_interfaces/srv/TimeOut_Request': msg_interfaces.srv.TimeOut_Request,
    'msg_interfaces/srv/TimeOut_Response': msg_interfaces.srv.TimeOut_Response,
  ...
  type MessageTypeClassConstructorMap = {
    ...
    'msg_interfaces/srv/ClearScore_Request': msg_interfaces.srv.ClearScore_RequestConstructor,
    'msg_interfaces/srv/ClearScore_Response': msg_interfaces.srv.ClearScore_ResponseConstructor,
    'msg_interfaces/srv/CloseKey_Request': msg_interfaces.srv.CloseKey_RequestConstructor,
    'msg_interfaces/srv/CloseKey_Response': msg_interfaces.srv.CloseKey_ResponseConstructor,
    'msg_interfaces/srv/FreePlay_Request': msg_interfaces.srv.FreePlay_RequestConstructor,
    'msg_interfaces/srv/FreePlay_Response': msg_interfaces.srv.FreePlay_ResponseConstructor,
    'msg_interfaces/srv/OpenKey_Request': msg_interfaces.srv.OpenKey_RequestConstructor,
    'msg_interfaces/srv/OpenKey_Response': msg_interfaces.srv.OpenKey_ResponseConstructor,
    'msg_interfaces/srv/Reset_Request': msg_interfaces.srv.Reset_RequestConstructor,
    'msg_interfaces/srv/Reset_Response': msg_interfaces.srv.Reset_ResponseConstructor,
    'msg_interfaces/srv/SpawnObj_Request': msg_interfaces.srv.SpawnObj_RequestConstructor,
    'msg_interfaces/srv/SpawnObj_Response': msg_interfaces.srv.SpawnObj_ResponseConstructor,
    'msg_interfaces/srv/StartRecord_Request': msg_interfaces.srv.StartRecord_RequestConstructor,
    'msg_interfaces/srv/StartRecord_Response': msg_interfaces.srv.StartRecord_ResponseConstructor,
    'msg_interfaces/srv/StartScore_Request': msg_interfaces.srv.StartScore_RequestConstructor,
    'msg_interfaces/srv/StartScore_Response': msg_interfaces.srv.StartScore_ResponseConstructor,
    'msg_interfaces/srv/Start_Request': msg_interfaces.srv.Start_RequestConstructor,
    'msg_interfaces/srv/Start_Response': msg_interfaces.srv.Start_ResponseConstructor,
    'msg_interfaces/srv/StopRecord_Request': msg_interfaces.srv.StopRecord_RequestConstructor,
    'msg_interfaces/srv/StopRecord_Response': msg_interfaces.srv.StopRecord_ResponseConstructor,
    'msg_interfaces/srv/TimeOut_Request': msg_interfaces.srv.TimeOut_RequestConstructor,
    'msg_interfaces/srv/TimeOut_Response': msg_interfaces.srv.TimeOut_ResponseConstructor,
  ...
  type ServicesMap = {
    ...
    'msg_interfaces/srv/ClearScore': msg_interfaces.srv.ClearScoreConstructor,
    'msg_interfaces/srv/CloseKey': msg_interfaces.srv.CloseKeyConstructor,
    'msg_interfaces/srv/FreePlay': msg_interfaces.srv.FreePlayConstructor,
    'msg_interfaces/srv/OpenKey': msg_interfaces.srv.OpenKeyConstructor,
    'msg_interfaces/srv/Reset': msg_interfaces.srv.ResetConstructor,
    'msg_interfaces/srv/SpawnObj': msg_interfaces.srv.SpawnObjConstructor,
    'msg_interfaces/srv/Start': msg_interfaces.srv.StartConstructor,
    'msg_interfaces/srv/StartRecord': msg_interfaces.srv.StartRecordConstructor,
    'msg_interfaces/srv/StartScore': msg_interfaces.srv.StartScoreConstructor,
    'msg_interfaces/srv/StopRecord': msg_interfaces.srv.StopRecordConstructor,
    'msg_interfaces/srv/TimeOut': msg_interfaces.srv.TimeOutConstructor,
